                          ...
                          <td style={{ padding: '14px 15px', textAlign: 'center' }}>
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                              ...
                              {(ach.team === 'SR | 3x') && (
                               ...
                               {(ach.team === 'TC') && (
                                <NextImage src="/chroniclesLogo.jpg" alt="TC" width={48} height={30} style={{ objectFit: 'contain' }} title="TC" />
                              )}
                               {(ach.team === 'Team rtg') && (
                                <NextImage src="/rtglogo.png" alt="Team rtg" width={48} height={30} style={{ objectFit: 'contain' }} title="Team rtg" />
                              )}
                               {(ach.team === 'Team glxy') && (
                                <NextImage src="/glxylogo.jpg" alt="Team glxy" width={48} height={30} style={{ objectFit: 'contain' }} title="Team glxy" />
                              )}
                              {(ach.team === 'Seven Esports') && (
                                <NextImage src="/7xLogo.png" alt="Seven Esports" width={48} height={30} style={{ objectFit: 'contain' }} title="Seven Esports" />
                              )}
                               {(ach.team === 'Stallion Esports') && (
                                <NextImage src="/StallionLogo.jpg" alt="Stallion Esports" width={48} height={30} style={{ objectFit: 'contain' }} title="Stallion Esports" />
                              )}
                               ...
                               {(ach.team === 'e8 Esports') && (
                                <NextImage src="/e8logo.png" alt="e8 Esports" width={48} height={30} style={{ objectFit: 'contain' }} title="e8 Esports" />
                              )}
                              {(ach.team === 'Rage') && (
